...
public class GenerateBingoCard {
  ...
  private static void generateCss(StringBuffer htmlOutput) {
    ...
    // TODO: Clean up unnecessary style attributes
...
*/    
  ...
  private static void generateJsFunctionBingoTileClick(StringBuffer htmlOutput) {
    ...
    htmlOutput.append(SCRIPT_INDENT + "  var form = element.children.namedItem(\"form\");\n");
    htmlOutput.append(SCRIPT_INDENT + "  var svg = element.children.namedItem(\"outlines\");\n");
    htmlOutput.append(SCRIPT_INDENT + "\n");
  ...
  private static void generateSvgDefs(StringBuffer htmlOutput) {
    ...
    htmlOutput.append(INDENT + "<svg display=\"none\">\n");
    ...
    htmlOutput.append(INDENT + "    <polygon id=\"p1-goal-met\" class=\"bingo-tile-indicator tile-captured-p1\" points=\"2,2 92,2, 2,92\" />\n");
    htmlOutput.append(INDENT + "    <polygon id=\"p1-goal-cannot-be-met\" class=\"bingo-tile-indicator tile-restricted\" points=\"2,2, 92,2, 2,92, 2,2 46,46\" />\n");
    htmlOutput.append(INDENT + "    \n");
    htmlOutput.append(INDENT + "    <polygon id=\"p2-goal-met\" class=\"bingo-tile-indicator tile-captured-p2\" points=\"94,94, 6,94 94,6\" />\n");
    htmlOutput.append(INDENT + "    <polygon id=\"p2-goal-cannot-be-met\" class=\"bingo-tile-indicator tile-restricted\" points=\"94,94, 6,94 94,6, 94,94, 50,50\" />\n");
    htmlOutput.append(INDENT + "  </defs>\n");
  ...
  private static void generateBorderTile(StringBuffer htmlOutput, int borderId, String borderType, char player, String title) {
    ...
    htmlOutput.append(INDENT + "  <form id=\"form\" style=\"display:none\">\n");
  ...
  private static void generateBingoTile(StringBuffer htmlOutput, int row, int col) {
    final String INDENT = "          ";
    String td = String.format("<td id=\"r%d-c%d\" class=\"bingo-tile\" onclick=\"clickBingoTile(this, event)\" onmouseenter=\"mouseBingoTile(this, event)\" onmousemove=\"mouseBingoTile(this, event)\" onmouseleave=\"mouseBingoTile(this, event)\">\n", row, col);
    String svg = String.format("<svg id=\"outlines\" width=\"%dpx\" height=\"%dpx\" style=\"display: block\">\n", TILE_CELL_SIZE, TILE_CELL_SIZE);
